...
namespace ImGui
{
    ...
    // Colour Utilities
    IMGUI_API ImVec4        ColourConvertU32ToFloat4(ImU32 in);
    IMGUI_API ImU32         ColourConvertFloat4ToU32(const ImVec4& in);
    IMGUI_API void          ColourConvertRGBtoHSV(float r, float g, float b, float& out_h, float& out_s, float& out_v);
    IMGUI_API void          ColourConvertHSVtoRGB(float h, float s, float v, float& out_r, float& out_g, float& out_b);
    // Text Utilities
