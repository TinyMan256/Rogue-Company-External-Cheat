...
#define MHYPROT_SERVICE_NAME "tinymanrc"
#define MHYPROT_DISPLAY_NAME "tinymanrc"
#define MHYPROT_SYSFILE_NAME "tinymanrc.sys"
#define MHYPROT_SYSMODULE_NAME "tinymanrc.sys"
